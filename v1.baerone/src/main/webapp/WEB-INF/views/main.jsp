		...
		<div class="container">
				...
				<div class="extras">
					<ul>
						<li class="shopping-cart-items"><i
							...
							href="myDelivery.do"><b>배송조회</b></a></li>
						<li></li>
			...
			<nav id="mainmenu" class="mainmenu">
				<ul>
					...
					<li class="has-submenu"><a href="#">회사소개</a>
					...
					<li class="has-submenu"><a href="#">배송신청/조회</a>
						<div class="mainmenu-submenu"
							style="padding-bottom: 1px; padding-top: 2px;">
							<div class="mainmenu-submenu-inner">
								<div>
					...
					<a href="#">관리자</a>
						<div class="mainmenu-submenu"
							...
							<div class="mainmenu-submenu-inner">
								...
								<div>
									<ul>
										<li><a href="deliveryReady.do">배송 준비</a></li>
									</ul>
	...
	<div class="homepage-slider">
		<div id="sequence">
			<ul class="sequence-canvas">
				...
				<li class="bg1">
					<!-- Slide Title -->
					<h2 class="title">드론이 배달합니다.</h2> <!-- Slide Text -->
					<h3 class="subtitle">차로하는 배달은 경쟁력이 없습니다. 이제 드론으로 시작하세요.</h3> <!-- Slide Image -->
					<img class="slide-img" src="img/homepage-slider/drone1.png"
					alt="Slide 1" />
				</li>
				<!-- End Slide 1 -->
				<!-- Slide 2 -->
				<li class="bg2">
					<!-- Slide Title -->
					<h2 class="title">30분 이내 배송</h2> <!-- Slide Text -->
					<h3 class="subtitle">차도가 아닌 하늘의 길로 날아갑니다.</h3> <!-- Slide Image -->
					<img class="slide-img" src="img/homepage-slider/drone1.png"
					alt="Slide 2" />
				</li>
				<!-- End Slide 2 -->
				...
				<li class="bg3">
					<!-- Slide Title -->
					<h2 class="title">운영비와 인건비 절감</h2> <!-- Slide Text -->
					<h3 class="subtitle" style="font-color: red">중간 중간 흘러나가는 돈을
						절약하세요</h3> <!-- Slide Image --> <img class="slide-img"
					src="img/homepage-slider/drone1.png" alt="Slide 3" />
				</li>
				<!-- End Slide 3 -->
			</ul>
			...
			<div class="row">
				<div class="col-md-4 col-sm-6">
					<div class="in-press press-wired">
						<a href="#">드론 배달을 통해 영업이익 20조 발생! 미래 지향적 투자를 통해 앞으로 유통 시장 점유
							1위를 목표하고 있다. </a>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="in-press press-mashable">
						<a href="#">Morbi eleifend congue elit nec sagittis. Praesent
							aliquam lobortis tellus, nec consequat vitae</a>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="calltoaction-wrapper">
						<h3>
							누구나 <span style="color: #DF9F3D; font-size: 20pt"> BAERONE
							</span>과 미래를 함께 할 수 있습니다.
						</h3>
						<a href="http://www.dragdropsite.com" class="btn btn-orange">문의하기</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-footer col-md-4 col-xs-6">
					...
					<p class="contact-us-details">
						<b>주소:</b> 대한민국 서울특별시 노원구 공릉동 삼육대학교<br /> <b>연락처:</b>010-9904-1890<br />
