...
">
				...
				<div class="row">
					...
					<div class="col-sm-12">
						<div class="blog-post blog-single-post">
                            <form action="updateDelivery.do" method="post" id="updateDelivery">
                            
							<div class="single-post-content">
						<c:forEach var="list" items="${list}">
								<h3>보내는 사람</h3><br>
									<div class="comment-form-wrapper">
									<input type="hidden" type="text" name="deliveryNo" id="deliveryNo" value="${list.deliveryNo}">
									<input type="hidden" type="text" name="fare" id="fare" value="${list.fare}">
									<input type="hidden" type="text" name="beaconName" id="beaconName" value="${list.beaconName}">
								...
								<div class="comment-form-wrapper">
				        				...
				        				<div class="form-group">
				        				 	<label for="comment-name"><i class="glyphicon glyphicon-user"></i> <b>이름</b></label>
											<input class="form-control" type="text" name="receiverName" value="${list.receiverName}">
										</div>
										<div class="form-group">
											<label for="comment-email"><i class="glyphicon glyphicon-phone"></i> <b>휴대폰</b></label>
											<input class="form-control" type="text"  name="receiverPhone" value="${list.receiverPhone}">
										</div>
                                        <div class="form-group">
											<label for="comment-email"><i class="glyphicon glyphicon-envelope"></i> <b>주소</b></label><br>
											<input class="form-control" type="text" id="receiverPostNo" name="receiverPostNo" style="width:50%; display:inline;" value="${list.receiverPostNo}">
                                            <input type="button" onclick="receiver_Postcode()" value="우편번호 찾기"><br>
										</div>
                                        <div class="form-group">
											<label for="comment-email"><b>지번 주소</b></label>
											<input class="form-control" type="text" id="receiverAddrOld" name="receiverAddrOld" value="${list.receiverAddrOld}">
										</div>
                                        <div class="form-group">
											<label for="comment-email"><b>도로명 주소</b></label>
											<input class="form-control" type="text" id="receiverAddrNew" name="receiverAddrNew" value="${list.receiverAddrNew}">
										</div>
                                        <div class="form-group">
											<label for="comment-email"><b>나머지 주소</b></label>
											<input class="form-control" type="text"  name="receiverAddrMisc" value="${list.receiverAddrMisc}">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input class="form-control" type="text"  name="productDetail" value="${list.productDetail}">
										</div>
					...
					<c:if test="${list.deliveryStatus eq '결제완료'}">
					<input type="button" class="btn btn-large pull-right" value="수정" onclick="updateDelivery()">
					</c:if>
                    </c:forEach>
                    </div>
		...
		<script type="text/javascript">
			function updateDelivery(){
				document.getElementById("updateDelivery").submit();
			}
		</script>
