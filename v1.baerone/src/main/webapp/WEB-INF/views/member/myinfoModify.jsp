        ...
        <div class="mainmenu-wrapper">
	        <div class="container">
		        ...
		        <nav id="mainmenu" class="mainmenu">
					<ul>
						<li class="logo-wrapper"><a href="main.jsp"><img src="img/top-logo.png" alt="Multipurpose Twitter Bootstrap Template"></a></li>
						<li class="active">
			...
			<div class="row">
				<div class="col-sm-6 col-sm-offset-3">
					<div class="basic-login">
						<form accept-charset="UTF-8" id="myinfoform" action="myinfo.do"
							method="post">
							<div class="form-group">
								<label for="register-userid"><b>아이디</b></label> <input
									value="${requestScope.member.userid}" name="userid"
									class="form-control" id="register-userid" type="text"
									readonly="readonly" placeholder="">

							</div>
							<div class="form-group">
								<label for="register-password"><b>비밀번호</b></label> <input
									value="${member.userpw }" name="userpw" class="form-control"
									id="register-password" type="password" placeholder="">
							</div>
							<div class="form-group">
								<label for="register-username"><b>이름</b></label> <input
									value="${requestScope.member.name }" name="username"
									class="form-control" id="register-username" type="text"
									 placeholder="">
							...
							<div class="form-group">
								<label for="register-birthday"><b>생년월일</b></label> <input
									value="${requestScope.member.birthday }" name="birthday"
									class="form-control" id="register-userid" type="text"
									 placeholder="">
							...
							<div class="form-group">
								<label for="register-gender"><b>성별</b></label><br> <input
									value="${requestScope.member.gender }" name="gender"
									class="form-control" id="register-gender" type="text"
									placeholder="" name="gender" >
							</div>
							<div class="form-group">
								<label for="register-phone"><b>핸드폰번호</b></label> <input
									value="${requestScope.member.phone }" name="phone"
									class="form-control" id="register-phone" type="text"
									 placeholder="">
							</div>
							<div class="form-group">
								<label for="register-email"><b>이메일</b></label> <input
									value="${requestScope.member.email }" name="email"
									class="form-control" id="register-email" type="text"
									 placeholder="">

							</div>
							<div class="form-group">
								<label for="register-postNo"><b>우편번호</b></label> <input
									value="${requestScope.member.postNo }" name="postNo"
									class="form-control" id="register-postNo" type="text"
									 placeholder="">

							</div>
							<div class="form-group">
								<label for="register-addressOld"><b>지번주소</b></label> <input
									value="${requestScope.member.addressOld }" name="addressOld"
									class="form-control" id="register-addressOld" type="text"
									 placeholder="">

							</div>
							<div class="form-group">
								<label for="register-addressNew"><b>도로명 주소</b></label> <input
									value="${requestScope.member.addressNew }" name="addressNew"
									class="form-control" id="register-addressNew" type="text"
									 placeholder="">

							</div>
							<div class="form-group">
								<label for="register-addressMisc"><b>나머지 주소</b></label> <input
									value="${requestScope.member.addressMisc }" name="userid"
									class="form-control" id="register-addressMisc" type="text"
									 placeholder="">
