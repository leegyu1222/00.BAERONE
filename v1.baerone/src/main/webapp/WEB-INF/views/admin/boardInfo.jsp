					...
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h3 class="panel-title">
								<i class="fa fa-bar-chart-o"></i> 게시글 관리
							</h3>
						</div>
						<div class="panel-body">
							<form action="adminBoardDelete.do" role="form">
								...
								<input type="hidden" name="page" value="${page}">
									...
									<div class="single-post-info">
										<i class="glyphicon glyphicon-time"></i>${board.writeDate} <a href="#" title="Show Comments"><i class="glyphicon glyphicon-comment"></i></a>
									</div>
								...
								<div align="right">
									...
									<a href="mgBoard.do?page=${page}" class="btn btn-default">취소</a>
								</div>
							</form>
						</div>
					</div>
